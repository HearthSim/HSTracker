...
- Fixed the session panel shortening a second place finish to "2..." in its latest games list, cutting off the longer hero names there instead of fitting them, and trimming a large MMR figure in that list.
