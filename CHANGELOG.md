...
- The markers over the opponent's hand now sit where Hearthstone Deck Tracker puts them, with the card that created or drew each one shown below the turn badge rather than inside it, and hovering a marker now names that card and says whether it created or drew the card in hand.
