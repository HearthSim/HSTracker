...
class MinionProxy: MonoHandle, MonoClassInitializer {    
    ...
    internal static var _isMech: OpaquePointer!
    ...
    @MonoHandleProperty(property: "AttachedModularEntity", owner: MinionProxy.self)
    var attachedModularEntity: MinionProxy
    ...
    func isMech() -> Bool {
        return MonoHelper.getBool(obj: self, method: MinionProxy._isMech)
    }
}
