...
class HeroPowerDataProxy: MonoHandle, MonoClassInitializer {
    ...
    static func initialize() {
        if HeroPowerDataProxy._class == nil {
            ...
            initializeProperties(properties: ["CardId", "IsActivated", "Data", "Data2", "Data3", "AttachedMinion", "AttachedMinionCapturedDuringCombat", "game_id"])
        }
    }
    ...
    @MonoPrimitiveProperty(property: "game_id", owner: HeroPowerDataProxy.self)
    var game_id: Int32
}
