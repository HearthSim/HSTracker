...
// HDT paints these three icons as a Rectangle whose Fill (or OpacityMask) is a
...
@available(macOS 10.15, *)
private struct HDTCanvasIcon<S: Shape>: View {
    let shape: S
...
@available(macOS 10.15, *)
private struct Tier7GearShape: Shape {
    ...
    private var header: some View {
        HStack(spacing: 0) {
            ...
            headerButton(margin: EdgeInsets(top: -3, leading: 0, bottom: -3, trailing: 2)) {
                ...
                HDTCanvasIcon(shape: Tier7GearShape(),
