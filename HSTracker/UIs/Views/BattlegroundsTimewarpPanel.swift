//
//  BattlegroundsTimewarpPanel.swift
//  HSTracker
//
//  Created by Francisco Moraes on 1/8/26.
...
class BattlegroundsTimewarpPanel: NSView {

    var boardCards: [MirrorBoardCard]?
    ...
    override init(frame frameRect: NSRect) {
        ...
        let message = String.localizedString("Compare Timewarped Cards", comment: "")
