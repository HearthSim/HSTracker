...
struct TagChangeActions {
    ...
    func callAction(game: Game, tag: GameTag, id: Int, value: Int, prevValue: Int) {
        ...
        case .transformed_from_card: self.transformedFromCardChange(game: game,
                                                                    id: id,
                                                                    value: value)
        default: break
        }
    ...
    private func transformedFromCardChange(game: Game, id: Int, value: Int) {
        if value == 0 { return }
    ...
    private func setHeroAsync(game: Game, id: Int) {
        ...
        DispatchQueue.global().async {
            ...
            if let playerEntity = game.playerEntity,
                ...
                Log.info?.message("playerEntity found playerClass : \(String(describing: game.player.playerClass)),"
            ...
            if let opponentEntity = game.opponentEntity,
                let entity = game.entities[id] {
                Log.info?.message("opponentEntity found playerClass : \(String(describing: game.opponent.playerClass)),"
