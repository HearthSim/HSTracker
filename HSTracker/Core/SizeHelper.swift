...
struct SizeHelper {
    ...
    private static var hearthstoneScreen: NSScreen {
        let hsFrame = hearthstoneFrame
    ...
    private static var _lastTimeCheckedHearthstoneFrame: Double = NSDate.distantPast().timeIntervalSince1970
    private static var _hearthstoneFrame: NSRect?
    private static var hearthstoneFrame: NSRect {
        if let _hearthstoneFrame = _hearthstoneFrame where NSDate().timeIntervalSince1970 - self._lastTimeCheckedHearthstoneFrame < 0.5 {
            return _hearthstoneFrame
        }
        
        _lastTimeCheckedHearthstoneFrame = NSDate().timeIntervalSince1970
    ...
    static func frameRelativeToHearthstone(frame: NSRect, _ relative: Bool = false) -> NSRect {
        ...
        let screenRect = hearthstoneScreen.frame
