...
class HSReplayPreferences: NSViewController, PreferencePane {
    ...
    private func updateStatus() {
        if Settings.hsReplayOAuthRefreshToken != nil {
            ...
            var message = String.localizedString("Logged in to HSReplay.net. Open your collection and the uploading will begin automatically.", comment: "")

            if let username = Settings.hsReplayUsername {
                message = String(format: String.localizedString("Logged in to HSReplay.net as %@. Open your collection and the uploading will begin automatically.", comment: ""), username)
            }
