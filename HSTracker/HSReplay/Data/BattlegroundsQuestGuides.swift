//
//  BattlegroundsQuestGuides.swift
//  HSTracker
//
...
// Field names verified against HDT's QuestGuidesApiResponse.cs
// (BattlegroundsQuestGuide), not inferred.
struct BattlegroundsQuestGuide: Decodable {
    var id: Int
    var quest: Int
...
typealias BattlegroundsQuestGuidesData = [BattlegroundsQuestGuide]
