...
class RandomTavernMinionBuffCounter: StatsCounter {
    ...
    override var localizedName: String {
        return String.localizedString("Counter_RandomTavernMinionBuff", comment: "")
    }
    ...
    override func handleTagChange(tag: GameTag, entity: Entity, value: Int, prevValue: Int) {
        ...
        if entity.card.id != CardIds.NonCollectible.Neutral.RandomMinionTavernMinionBuffPlayerEnchDnt {
            return
        }
